 ...
 * 
 */
public class final_token_Main {


	public static void main(String[] args) throws Exception {
		// main entrance
		long startTime=System.currentTimeMillis(); //star time of running code
		final_token_Main hm1 = new final_token_Main();
		hm1.PreProcess("article_c");
	...
	public void PreProcess(String dataType) throws Exception {
		...
		FileWriter wr = new FileWriter(Path.token_result);
		...
		while ((doc = corpus.nextDocument()) != null) {
			...
			String content = String.valueOf(doc.get(docno));

			if (!re.contains(docno)) {
